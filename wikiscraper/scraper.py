...
class Scraper():
    ...
    Attributes:
        ...
        page_to_fetch (str): The raw page name to fetch from the wiki.
    ...
    def __init__(self, phrase: str=None, wiki_base_url: str = config.BULBAPEDIA_MAIN_PAGE, use_local_html_file_instead=False):
        ...
        Args:
            phrase (str): The page name or phrase to fetch. Can include an anchor (e.g., 'Pikachu#Abilities').
    ...
    def scrape(self) -> Page:
        ...
        This method will either:
            ...
            - Read the HTML from a local cached file if `use_local_html_file_instead` is True.
